...
export const INITIAL_REPAIR_RECORDS: RepairRecord[] = [
  // August 2026
  { id: 'rep_001', ticketCode: 'FOL-8801', date: '2026-08-01', reportDate: '2026-08-01', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0101', technician: 'Ing. Carlos Mendoza', issueType: 'Falla en Cable Alimentador FO-01', cable: 'FO-01 Alimentador Metro', terminal: 'A1', pair: '12', grupo: 'Ingeniería Exterior', claveCode: 'C-01', status: 'resolved', mttrHours: 1.5, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-8801', Terminal: 'A1', Par: '12' } },
  { id: 'rep_002', ticketCode: 'REP-2026-0802', date: '2026-08-01', reportDate: '2026-07-25', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0102', technician: 'Téc. Roberto Gómez', issueType: 'Caída de Enlace GPON OLT-1', cable: 'CABLE-GPON-04', terminal: 'B2', pair: '04', grupo: 'Banda Ancha', claveCode: 'C-02', status: 'resolved', mttrHours: 2.1, workGroupId: 'grp_broad', rawRowData: { Terminal: 'B2', Par: '04' } },
  { id: 'rep_003', ticketCode: 'FOL-9921', date: '2026-08-01', reportDate: '2026-07-28', centralId: 'cnt_norte', centralName: 'Central Norte (Tele)', serviceNumber: '212-555-0199', technician: 'Téc. María Elena', issueType: 'Par Sulfatado en Multipair', cable: 'Cable 04 Norte', terminal: 'B2', pair: '06', grupo: 'Ingeniería Exterior', claveCode: 'C-01', status: 'resolved', mttrHours: 1.1, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-9921', Terminal: 'B2', Par: '06' } },
  { id: 'rep_004', ticketCode: 'FOL-9921', date: '2026-08-02', reportDate: '2026-08-02', centralId: 'cnt_norte', centralName: 'Central Norte (Tele)', serviceNumber: '212-555-0199', technician: 'Téc. Roberto Gómez', issueType: 'Reincidencia: Ruido en la línea', cable: 'Cable 04 Norte', terminal: 'B2', pair: '06', grupo: 'Ingeniería Exterior', claveCode: 'C-03', status: 'resolved', mttrHours: 1.8, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-9921', Terminal: 'B2', Par: '06' } },
  // Caso 1 de Canibalización de Pares: Téc. Roberto Gómez repara servicio en Cable 04 Norte, Terminal B2; 24h después, vecino 212-555-0210 en terminal hermano B4 reporta línea muda!
  { id: 'rep_pair_01', ticketCode: 'FOL-9930', date: '2026-08-03', reportDate: '2026-08-02', centralId: 'cnt_norte', centralName: 'Central Norte (Tele)', serviceNumber: '212-555-0210', technician: 'Téc. Javier Ortiz', issueType: 'Línea cortada sin tono tras manipulación', cable: 'Cable 04 Norte', terminal: 'B4', pair: '08', grupo: 'Ingeniería Exterior', claveCode: 'C-02', status: 'resolved', mttrHours: 2.0, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-9930', Terminal: 'B4', Par: '08' } },
  // Caso 2 de Canibalización de Pares (Mismo Terminal Exacto): Téc. Andrés Silva atiende terminal D1 en Cable 08; 48h después vecino del mismo terminal D1 reporta par descolgado
  { id: 'rep_pair_02a', ticketCode: 'FOL-5510', date: '2026-08-02', reportDate: '2026-08-01', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0450', technician: 'Téc. Andrés Silva', issueType: 'Acometida reconectada', cable: 'Cable 08 Metro', terminal: 'D1', pair: '02', grupo: 'Ingeniería Exterior', claveCode: 'C-01', status: 'resolved', mttrHours: 1.2, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-5510', Terminal: 'D1' } },
  { id: 'rep_pair_02b', ticketCode: 'FOL-5515', date: '2026-08-04', reportDate: '2026-08-03', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0458', technician: 'Ing. Carlos Mendoza', issueType: 'Par vecino desprendido en bornera D1', cable: 'Cable 08 Metro', terminal: 'D1', pair: '03', grupo: 'Ingeniería Exterior', claveCode: 'C-03', status: 'resolved', mttrHours: 1.5, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-5515', Terminal: 'D1' } },
  { id: 'rep_005', ticketCode: 'FOL-7740', date: '2026-08-02', reportDate: '2026-07-30', centralId: 'cnt_este', centralName: 'Central Este', serviceNumber: '212-555-0340', technician: 'Ing. Luis Fernández', issueType: 'Módulo SFP Quemado en Switch', cable: 'FOS-08 Este', terminal: 'C1', grupo: 'Conmutación', claveCode: 'C-04', status: 'resolved', mttrHours: 3.0, workGroupId: 'grp_conm', rawRowData: { Folio: 'FOL-7740', Terminal: 'C1' } },
  { id: 'rep_006', ticketCode: 'FOL-8801', date: '2026-08-03', reportDate: '2026-08-03', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0101', technician: 'Téc. Roberto Gómez', issueType: 'Reincidencia: Atenuación en FOS', cable: 'FO-01 Alimentador Metro', terminal: 'A1', grupo: 'Transmisión', claveCode: 'C-04', status: 'resolved', mttrHours: 2.5, workGroupId: 'grp_trans', rawRowData: { Folio: 'FOL-8801', Terminal: 'A1' } },
  { id: 'rep_007', ticketCode: 'REP-2026-0806', date: '2026-08-03', reportDate: '2026-08-01', centralId: 'cnt_sur', centralName: 'Central Sur', serviceNumber: '212-555-0550', technician: 'Téc. Javier Ortiz', issueType: 'Fallo de Rectificador Baterías', cable: 'PW-RECT-02', terminal: 'E1', grupo: 'Energía', claveCode: 'C-05', status: 'resolved', mttrHours: 4.2, workGroupId: 'grp_ener', rawRowData: { Terminal: 'E1' } },
  { id: 'rep_008', ticketCode: 'FOL-9921', date: '2026-08-03', reportDate: '2026-08-03', centralId: 'cnt_norte', centralName: 'Central Norte (Tele)', serviceNumber: '212-555-0199', technician: 'Ing. Carlos Mendoza', issueType: 'Cambio total de acometida', cable: 'Cable 04 Norte', terminal: 'B2', grupo: 'Ingeniería Exterior', claveCode: 'C-01', status: 'resolved', mttrHours: 2.2, workGroupId: 'grp_ing_ext', rawRowData: { Folio: 'FOL-9921', Terminal: 'B2' } },
  { id: 'rep_009', ticketCode: 'FOL-7740', date: '2026-08-04', reportDate: '2026-08-04', centralId: 'cnt_este', centralName: 'Central Este', serviceNumber: '212-555-0340', technician: 'Téc. Javier Ortiz', issueType: 'Puerto Flapping en DSLAM', cable: 'DSLAM-CAB-02', terminal: 'C2', grupo: 'Conmutación', claveCode: 'C-02', status: 'in_progress', mttrHours: 1.0, workGroupId: 'grp_conm', rawRowData: { Folio: 'FOL-7740', Terminal: 'C2' } },
  { id: 'rep_010', ticketCode: 'REP-2026-0809', date: '2026-08-04', reportDate: '2026-08-02', centralId: 'cnt_centro', centralName: 'Central Fibra Centro', serviceNumber: '212-555-0811', technician: 'Téc. Andrés Silva', issueType: 'Divisor Splitter FTTH dañado', cable: 'FTTH-SPLIT-16', terminal: 'F1', grupo: 'Banda Ancha', claveCode: 'C-03', status: 'resolved', mttrHours: 1.4, workGroupId: 'grp_broad', rawRowData: { Terminal: 'F1' } },
  { id: 'rep_014', ticketCode: 'REP-2026-0804', date: '2026-08-04', reportDate: '2026-08-04', centralId: 'cnt_oeste', centralName: 'Central Digital Oeste', serviceNumber: '212-555-0712', technician: 'Ing. Carlos Mendoza', issueType: 'Restablecimiento Par Secundario', cable: 'CU-100 Oeste', terminal: 'G1', grupo: 'Ingeniería Exterior', claveCode: 'C-01', status: 'resolved', mttrHours: 1.8, workGroupId: 'grp_ing_ext', rawRowData: { Terminal: 'G1' } },

  // July 2026
  { id: 'rep_011', ticketCode: 'REP-2026-0710', date: '2026-07-05', reportDate: '2026-07-05', centralId: 'cnt_metro', centralName: 'Central Metropolitana', serviceNumber: '212-555-0101', technician: 'Ing. Carlos Mendoza', issueType: 'Reemplazo de latiguillo óptico', cable: 'FO-01 Alimentador Metro', terminal: 'A1', grupo: 'Transmisión', claveCode: 'C-01', status: 'resolved', mttrHours: 1.2, workGroupId: 'grp_trans' },
  { id: 'rep_012', ticketCode: 'REP-2026-0711', date: '2026-07-12', reportDate: '2026-06-28', centralId: 'cnt_sur', centralName: 'Central Sur', serviceNumber: '212-555-0550', technician: 'Téc. Javier Ortiz', issueType: 'Revisión de fusible Batería', cable: 'PW-RECT-02', terminal: 'E1', grupo: 'Energía', claveCode: 'C-05', status: 'resolved', mttrHours: 2.0, workGroupId: 'grp_ener' },
  { id: 'rep_013', ticketCode: 'REP-2026-0720', date: '2026-07-20', reportDate: '2026-07-20', centralId: 'cnt_norte', centralName: 'Central Norte (Tele)', serviceNumber: '212-555-0909', technician: 'Téc. Roberto Gómez', issueType: 'Mantenimiento preventivo OLT', cable: 'CABLE-GPON-04', terminal: 'B2', grupo: 'Banda Ancha', claveCode: 'C-02', status: 'resolved', mttrHours: 1.5, workGroupId: 'grp_broad' }
];
